    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto " href="{{ route('createDonasi') }}">Mulai Donasi<i class="bi bi-heart-fill"></i></a></li>
          <li><a class="nav-link scrollto " href="#contact">Kontak<i class="bi bi-telephone"></i></a></li>
          <li class="dropdown"><span>Login</span> <i class="bi bi-box-arrow-in-right"></i>
            <ul>
